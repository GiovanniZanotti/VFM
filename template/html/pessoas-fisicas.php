            ...
            <div class="item-v2">
                ...
                <div class="servicos-v2">
                    <div class="servico-v2">
                        ...
                        <p>Consultoria em assuntos relacionados a IRPF e Bacen.</p>
                    </div>
                    <div class="servico-v2">
                        <i class="far fa-check-circle"></i>
                        <p>Expatriados.</p>
                    ...
                    <div class="servico-v2">
                        <i class="far fa-check-circle"></i>
                        <p>Regularização de saída definitiva do Brasil.</p>
                    </div>
                </div>
                
                <img src="[template]/pw-images/images/pessoas-fisicas.jpg" alt="">
