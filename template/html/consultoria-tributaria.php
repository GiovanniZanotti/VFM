          ...
          <div class="titulo">
            ...
            <div class="item-v2">
                ...
                <div class="servicos-v2">
                    ...
                    <div class="servico-v2">
                        <i class="far fa-check-circle"></i>
                        <p>Análise da opção pelo Lucro Real, Lucro Presumido ou Simples Nacional.</p>
                    </div>
                    <div class="servico-v2">
                        <i class="far fa-check-circle"></i>
                        <p>Escrituração fiscal automatizada.</p>
                    </div>
                    <div class="servico-v2">
                        <i class="far fa-check-circle"></i>
                        <p>Apuração e revisão de tributos.</p>
                    </div>
                </div>
                
                <img src="[template]/pw-images/images/consultoria-tributaria.jpg" alt="">
